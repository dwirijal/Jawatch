  ...
  return (
    <form action="/search" className="flex-1 max-w-[420px] relative">
      <input
        ...
        className="w-full bg-card border border-border rounded-page px-3.5 py-2 text-body font-mono text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-amber/50 focus:ring-1 focus:ring-amber/20 transition-all"
      />
